...
def run_round(state, warmup=False):
    ...
    dqn_agent.append_sample(state, agent_action_index, reward, next_state, done)

    return next_state, reward, done, success, agent_action_index
...
def train_run():
    ...
    while episode < NUM_EP_TRAIN:
        ...
        state = state_tracker.get_state()
        while not done:
            next_state, reward, done, success, action_index = run_round(state)
            period_reward_total += reward
            
            dqn_agent.append_sample(state, action_index, reward, next_state, done)
            state = next_state
        ...
        print("Episode:"+str(episode)+"      "+"SUCCESS RATE:"+str(success_rate)+"    "+"Reward:"+str(avg_reward))
